...
namespace QuanLyBanVeMayBay
{
    public partial class FormLogin : Form
    {
        ...
        private void LoginBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                client.BaseAddress = new Uri("https://localhost:44315/");   //dia chi backend
                ...
                var response = client.PostAsJsonAsync("api/login", dtoUser).Result;     // gui DTO user len web sever bang Method POST, va nhan ket qua tra ve
